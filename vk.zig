...
pub const SurfaceCounterFlagsEXT = packed struct {
    vblank_ext: bool align(@alignOf(Flags)) = false,
    _reserved_bit_1: bool = false,
    _reserved_bit_2: bool = false,
    _reserved_bit_3: bool = false,
    _reserved_bit_4: bool = false,
...
pub const AccelerationStructureMemoryRequirementsTypeKHR = enum(c_int) {
    object_khr = 0,
    build_scratch_khr = 1,
...
pub const PerformanceCounterDescriptionFlagsKHR = packed struct {
    performance_impacting_khr: bool align(@alignOf(Flags)) = false,
...
pub const PfnGetAccelerationStructureMemoryRequirementsKHR = fn (
    device: Device,
...
pub const PfnBindAccelerationStructureMemoryKHR = fn (
    device: Device,
    bind_info_count: u32,
...
pub const PfnCmdBuildAccelerationStructureKHR = fn (
    command_buffer: CommandBuffer,
    info_count: u32,
...
pub const PfnCmdBuildAccelerationStructureIndirectKHR = fn (
    command_buffer: CommandBuffer,
...
pub const PfnBuildAccelerationStructureKHR = fn (
    device: Device,
    info_count: u32,
    p_infos: [*]const AccelerationStructureBuildGeometryInfoKHR,
    pp_offset_infos: [*]const *const AccelerationStructureBuildOffsetInfoKHR,
